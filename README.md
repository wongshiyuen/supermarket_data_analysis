...
- ANOVA was used to determine if there are significant differences in sales between all supermarket branches.

## Results
The table below shows the total sales and taxes of each branch in descending order.
...
The table below shows the product lines with highest sales with respect to branch ranked in descending order.
